...
// Los mismos atributos que aparecen en la BBDD
public class Cliente {
    ...
    public Cliente() {
        ...
        // En ocaciones para crear obj solo asignando el id (por ejemplo borrar)
    public Cliente(int idCliente) {
        this.idCliente = idCliente;
    }

        // Para agregar un nuevo registro (el id lo genera en automático)
    public Cliente(String nombre, String apellido, String email, String telefono, double saldo) {
        ...
        // Cuando modificamos un obj del tipo Cliente
